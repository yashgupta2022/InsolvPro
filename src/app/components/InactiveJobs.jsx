...
export default function ActiveJobs({ setActiveTab }) {
    ...
    return (
        <div className='w-full '>
            <h2 className="flex flex-col w-full mb-4 text-2xl font-bold">Inactive Jobs</h2>
            ...
            {/* Job listings */}
            <div className="flex flex-col items-center h-[calc(100vh-325px)] my-4 space-y-4 overflow-y-auto">
